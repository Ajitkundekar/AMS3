<%@ Page Title="AMS | Login Page" Language="C#" MasterPageFile="~/navfooter.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="AMS_3sem.Login" %>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            if (eyeOpenIcon && eyeCloseIcon) {
                ...
                console.error("Eye nathi dekhati... ");
            }
        });
    </script>
