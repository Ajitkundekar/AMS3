...
namespace AMS_3sem
{
    public partial class Registration : System.Web.UI.Page
    {
        ...
        protected void registerButton_Click(object sender, EventArgs e)
        {
            ...
            string insertQuery = "INSERT INTO tbl_user (fullname, email, mobile, password, user_img,role) " +
                                 "VALUES (@FullName, @Email, @MobileNumber, @Password, @UserImg,@Role)";
            try
            {
        ...
        private const string con = "Data Source=AK\\SQLEXPRESS; Initial Catalog=AMS; Integrated Security=True";
