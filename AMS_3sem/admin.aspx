<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="AMS_3sem.admin1" %>
        ...
        <div class="flex-1 overflow-x-hidden overflow-y-auto p-4">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                <div class="bg-purple-200 p-6 rounded-md shadow-md">
                    ...
                    <asp:Label ID="lblTotalProducts" runat="server" CssClass="text-3xl font-bold"></asp:Label>
                </div>

                <div class="bg-purple-200 p-6 rounded-md shadow-md">
                    <h3 class="text-xl font-semibold mb-2">Total Users</h3>
                    <asp:Label ID="lblTotalUsers" runat="server" CssClass="text-3xl font-bold"></asp:Label>
                </div>
