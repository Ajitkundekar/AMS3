<%@ Page Title="AMS | Auction Product's Report" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="productsreports.aspx.cs" Inherits="AMS_3sem.adminpage.productsreports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server" id="tblform">
                    ...
                    <asp:Button runat="server"  CssClass="btn  text-black p-1 rounded hover:border hover:bg-red-600 btn-right"  Text="Generate Report" OnClick="btnDownloadReport_Click" />
                            <asp:Button runat="server"  CssClass="btn  text-black p-1 rounded hover:border hover:bg-red-600 btn-right"  Text="   Upcoming Auction Report" OnClick="btnDownloadReport_Click1" />
