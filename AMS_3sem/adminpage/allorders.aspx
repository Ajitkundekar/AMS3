<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="allorders.aspx.cs" Inherits="AMS_3sem.adminpage.allorders" %>
            ...
            <div class="bg-purple-200 border border-gray-200 rounded shadow p-6">
                <div class="overflow-x-auto">
                    ...
                    <form runat="server">
                        ...
                        <asp:Button ID="Button3" runat="server" CssClass="btn  text-black p-1 rounded hover:border hover:bg-red-600 btn-right"  Text="Genrate Report" OnClick="btnDownloadReport_Click0" />
                                        ...
                                        <tr class="hover:bg-purple-100 transition-all">
                                            ...
                                            <td class="py-2 px-4 border-b">
                                                <asp:Button runat="server" ID="StatusButton"
                                                    CssClass='<%# Eval("Status").ToString() == "1" ? "btn bg-purple-800 text-white p-1 rounded hover:bg-purple-600" : "btn bg-green-800 text-white p-1 rounded hover:bg-green-600" %>'
                                                    Text='<%# Eval("Status").ToString() == "1" ? "Processing" : "Delivered" %>'
                                                    CommandName="UpdateStatus"
                                                    OnClick="confirmDeliveryButton_Click" />
                                                <asp:HiddenField ID="OrderNoHiddenField" Value='<%# Eval("orderno") %>' runat="server" />
                                            ...
                                            <td class="py-2 px-4 border-b">
                                                <asp:Button runat="server" ID="Button1"
                                                    CssClass="btn bg-green-800 text-white p-1 rounded hover:bg-green-600" Text="Send Mail"
                                                    OnClick="mailsend" />
                                                <asp:HiddenField ID="ordernofield" Value='<%# Eval("orderno") %>' runat="server" />
                                                <asp:HiddenField ID="datefield" Value='<%# Eval("date") %>' runat="server" />
                                                <asp:HiddenField ID="customernamefield" Value='<%# Eval("customername") %>' runat="server" />
                                                <asp:HiddenField ID="emailhiddenfield" Value='<%# Eval("EmailAddress") %>' runat="server" />
                                                <asp:HiddenField ID="Productfield" Value='<%# Eval("Product") %>' runat="server" />
                                                <asp:HiddenField ID="Amountfield" Value='<%# Eval("Amount") %>' runat="server" />
