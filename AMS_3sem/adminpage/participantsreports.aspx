<%@ Page Title="" Language="C#" MasterPageFile="~/admin.Master" AutoEventWireup="true" CodeBehind="participantsreports.aspx.cs" Inherits="AMS_3sem.adminpage.participantsreports" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <form runat="server">
<asp:Button ID="Button1" runat="server"  CssClass="btn  text-black p-1 rounded hover:border hover:bg-red-600 btn-right" Text="Genrate Report"  OnClick="btnDownloadReport_Click" />
                ...
                <asp:Repeater ID="UserRepeater" runat="server">
                    <ItemTemplate>
                        <div class="bg-white p-4 rounded-lg shadow-md transition duration-300 transform hover:shadow-lg hover:bg-purple-100 hover:scale-105" >
                            <img src='<%# Eval("user_img") %>' class="w-full h-41 mb-4 rounded-md hover:scale-105 transition-transform duration-300" />
